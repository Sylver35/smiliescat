...
$lang = array_merge($lang, array(
	...
	'ACP_SC_SMILIES_EXPLAIN'	=> 'On this page, you can assign the categories to smilies.<br>The smilies will be displayed in a popup classified in the assigned category.<br>Smilies with no assigned category will be in the automatic category titled “Unclassified”.<br>Undisplayed smileys will be in the special category "Undisplayed".',
	'ACP_SC_CONFIG'				=> 'Configuration of categories',
	'ACP_SC_CONFIG_EXPLAIN'		=> 'On this page, you can manage the categories of smilies.<br>Categories in orange will not be displayed because they do not contain any smileys.<br>Add, edit, delete categories. Change the display order and define the translations in the activated languages.',
	'SC_CATEGORY'				=> 'Category',
	'SC_CATEGORY_LANG'			=> 'Language',
	'SC_CATEGORY_DEFAUT'		=> 'Unclassified',
	'SC_CATEGORY_NOT'			=> 'Undisplayed',
	'SC_CATEGORY_ID'			=> 'ID',
	...
	'SC_CATEGORY_EDIT'			=> 'Modify Category',
	...
	'SC_SMILIES_EMPTY_CATEGORY'	=> 'This category does not contain any smileys',
	...
	'SC_SMILIES_TITLE'			=> 'View more smilies ranked in categories',
	'SC_SMILIES_CLOSE'			=> 'Close the panel',
	'SC_SMILIES_CLOSE_WINDOW'	=> 'Close window',
	...
	'LOG_SC_DELETE_CAT_LANG'	=> '<strong>Removed smiley categories in language</strong> » %s',
