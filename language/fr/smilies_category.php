...
$lang = array_merge($lang, array(
	...
	'ACP_SC_SMILIES_EXPLAIN'	=> 'Sur cette page, vous pouvez attribuer les catégories des smileys.<br />Les smileys seront affichés dans une popup classés dans la catégorie attribuée.<br />Les smileys n’ayant pas de catégorie attribuée seront dans la dernière catégorie automatique intitulée “Non classés”',
	...
	'SC_CATEGORY_ANY'			=> 'Aucune catégorie',
	...
	'SC_MOVE_SUCCESS'			=> 'L’ordre d’affichage des catégories a bien été modifié',
	...
	'SC_CATEGORY_ERROR'			=> 'Vous devez remplir tous les champs “%s”',
	'SC_SMILIES_TITLE'			=> 'Voir plus de smileys classés en catégories',
	'LOG_SC_ADD_CAT'			=> '<strong>Création d’une catégorie de smileys </strong><br>» %s',
	'LOG_SC_EDIT_CAT'			=> '<strong>Édition d’une catégorie de smileys </strong><br>» %s',
	'LOG_SC_MOVE_UP_CAT'		=> '<strong>Remontée d’une catégorie de smileys </strong><br>» %s',
	'LOG_SC_MOVE_DOWN_CAT'		=> '<strong>Descente d’une catégorie de smileys </strong><br>» %s',
	'LOG_SC_DELETE_CAT'			=> '<strong>Suppression d’une catégorie de smileys </strong><br>» %s',
	'SC_VERSION_COPY'			=> '<a href="%1$s" onclick="window.open(this.href);return false;">Breizh Smilies Category v%2$s</a> © 2020 - Breizhcode - The Breizh Touch',
));
