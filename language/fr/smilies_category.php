...
$lang = array_merge($lang, array(
	...
	'SC_VERSION_COPY'			=> '<a href="%1$s" onclick="window.open(this.href);return false;">Breizh Smilies Category v%2$s</a> © 2020 - Breizhcode - The Breizh Touch',// Don't translate this please ^-^
));
